...
window.customElements.define('wc-app', App);"use strict";
...
window.customElements.define('wc-center', Center);"use strict";
...
window.customElements.define('wc-flip', Flip);"use strict";
...
var Icon = function (_HTMLElement) {
   ...
   */
		...
		value: function attributeChangedCallback(attr, oldval, newval) {
			...
			var obs = Icon.observedAttributes;
...
window.customElements.define('wc-icon', Icon);"use strict";
 ...
 */
var Melify = function (_HTMLElement) {
	_inherits(Melify, _HTMLElement);

	function Melify() {
		_classCallCheck(this, Melify);

		console.group("Melify.constructor");

		var _this = _possibleConstructorReturn(this, (Melify.__proto__ || Object.getPrototypeOf(Melify)).call(this));
   ...
   */
		value: function attributeChangedCallback(attr, oldval, newval) {
			...
			var obs = Melify.observedAttributes;
...
window.customElements.define('wc-melify', Melify);"use strict";
...
window.customElements.define('wc-stocks', Stocks);"use strict";
...
window.customElements.define('wc-ticker', Ticker);"use strict";
...
window.customElements.define('wc-tile', Tile);"use strict";
